...
func (t *CliTransport) prepareEnv(provider *server.CliProvider) []string {
...
func (t *CliTransport) extractManual(output, name string) []server.Tool {
	var manuals server.UtcpManual
	// try full output
